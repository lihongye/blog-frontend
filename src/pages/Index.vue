<template>
	<div>
		<layout>
			...
			<header
				class="masthead"
				:style="{backgroundImage: `url(http://106.75.37.42:1337${general.cover.url})`}"
			>
						...
						<!-- <div class="post-preview">
							<a href="post.html">
								<h2 class="post-title">
									...
									heartbeats. I don't intend to waste any of
									mine.
								</h2>
							</a>
							<p class="post-meta">
...
<script>
import { Pager } from 'gridsome' // 导入后需在components中进行注册，page-query标签中也需要有相对应的查询属性字段
